...
export default function TripDetailClient({
  ...
  return (
    <>
      ...
      <div
        className="breadcrumbs animate-fade-in"
        style={{
          fontSize: "12px",
          color: "var(--muted)",
          marginBottom: "20px",
      ...
      {loading ? (
        <section className="panel">
          Đang tải thông tin chuyến xe và sơ đồ ghế...
        </section>
      ) : null}
      {error ? (
        <section className="panel">
        ...
        >
          ...
          <aside style={{ display: "grid", gap: "20px" }}>
            <div className="panel" style={{ padding: "20px" }}>
              ...
              >
                ...
                <div style={{ textAlign: "center", position: "relative" }}>
                  ...
                  >
                    {Math.floor(detail.trip.durationMinutes / 60)}h{" "}
                    {detail.trip.durationMinutes % 60}m
                  </span>
                  <div
                    style={{
                      height: "2px",
            ...
            >
              ...
              <div
                style={{ display: "grid", gap: "8px", color: "var(--muted)" }}
              >
                <div>
                  <strong>Đón:</strong>{" "}
                  {detail.pickupPoints.map((stop) => stop.name).join(", ") ||
                    "Theo tuyến"}
                </div>
                <div>
                  <strong>Trả:</strong>{" "}
                  {detail.dropoffPoints.map((stop) => stop.name).join(", ") ||
                    "Theo tuyến"}
                </div>
              </div>
              <div
          ...
          <main className="panel" style={{ padding: "24px" }}>
            ...
            >
              <div>
                ...
                >
                  Chọn chỗ ngồi phù hợp và tiếp tục đặt vé
                </p>
              </div>
              <span className="status">
                {detail.trip.availableSeats} ghế trống
              </span>
            </div>
