...
-- Routes, route stops, upcoming trips, and trip seats.
-- Vehicle seat layouts are NOT redefined here: the B-3 layouts above are
-- the source of truth (PT A*/B*, TB L*, KH S* labels). Statements below are
-- idempotent and only add rows the B-3 seed does not already provide.
-- Trips use current_date so the search demo always has upcoming trips.
-- =====================================================================
